...
def parse_args():
    ...
    parser.add_argument("--env_id", type=str, default="SingleDroneGoal-v0")
    parser.add_argument("--test", action="store_true")
    parser.add_argument("--gui", action="store_true")
    parser.add_argument("--log", action="store_true")
    parser.add_argument("--plot", action="store_true")
    parser.add_argument("--clear_results", action="store_true")
    parser.add_argument("--output_folder", type=str, default="new_results")
    parser.add_argument("--exp_name", type=str, default="test_nav_vel_ctrl")
